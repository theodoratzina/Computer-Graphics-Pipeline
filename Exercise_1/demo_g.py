...
uvs = data['v_uvs']                    # (L, 2) texture coordinates (not used for Gouraud)
...
# Render the image using Gouraud shading
print('\n2. Rendering with Gouraud shading...')
img = render_img(faces, vertices, vcolors, uvs, depth, shading='g')
...
cv2.imwrite('output_gouraud.png', img_bgr)
print('   Saved: output_gouraud.png')

# Display the image
print('\n4. Displaying image...')
cv2.imshow('Gouraud Shading', img_bgr)
cv2.waitKey(0)
